  ...
  return (
    ...
    >
      ...
      >
        ...
        <Box
          sx={{ display: "flex", alignItems: "center", marginRight: "4rem" }}
        >
          <DatePicker
      ...
      >
        ...
        <DialogActions>
          <Button onClick={handleDialogClose} sx={{ color: "#f44336" }}>
            İptal
          </Button>
          <Button onClick={handleDialogSubmit} sx={{ color: "#90caf9" }}>
            Kaydet
          </Button>
        </DialogActions>
      </Dialog>
