              ...
              >
                ...
                <Box
                  ...
                  sx={{
                    ...
                    color: "#00B074",
                    cursor:
                      startIndex + ReviewPerPage >= review.length
                        ? "not-allowed"
                        : "pointer", // Sonraki buton son sayfadaysa disabled
                    opacity:
                      startIndex + ReviewPerPage >= review.length ? 0.5 : 1, // Disabled durumda opacity azalt
                    "&:hover": {
                      backgroundColor:
                        startIndex + ReviewPerPage >= review.length
                          ? "transparent"
