...
const AboutSahanCepte = () => {
  ...
  const questions = [
    {
      id: 1,
      question: "Sahan Cepte Nedir?",
      answer:
        "Sahan Cepte, kullanıcıların belirli sahalara gitmeden önce hızlı ve kolay bir şekilde rezervasyon yapabilmelerini sağlayan bir online rezervasyon sistemidir.",
    },
    {
      id: 2,
      question: "Sahan Cepte'de hangi sahalar geçerlidir?",
      answer:
        "Bu özellik, platformumuzda Sahan Cepte ile uyumlu olan sahalar için geçerlidir.",
    },
    {
      id: 3,
      question: "Sahan Cepte ödemesi nasıl yapılır?",
      answer: "Ödeme işlemi tamamen güvenli bir ortamda gerçekleştirilir.",
    },
    {
      id: 4,
    ...
    {
      id: 6,
      question: "Sahan Cepte ile yapılan rezervasyonu nasıl iptal ederim?",
      answer:
        "Rezervasyon iptalini kolayca uygulama veya web sitesi üzerinden gerçekleştirebilirsiniz.",
    },
    {
      id: 7,
      question: "İptal süresine dikkat etmem gerekiyor mu?",
      answer: "Evet, sahaların belirlediği iptal süreleri mevcuttur.",
    },
    {
      id: 8,
      question: "Sahan Cepte ile yapılan ödemeler için fatura alabilir miyim?",
      answer:
        "Evet, Sahan Cepte üzerinden yapılan ödemeler için, e-posta adresinize dijital fatura gönderilir.",
    },
    {
      id: 9,
      question: "Sahan Cepte'de ödeme sırasında sorun yaşarsam ne yapmalıyım?",
      answer:
        "Ödeme sırasında bir sorun yaşarsanız, destek ekibimizle iletişime geçebilirsiniz.",
    },
  ];
