...
const Support = () => {
  ...
  const questions = [
    ...
    { id: 2, question: "Sahan Cepteyi kullanmak ücretli mi?", answer: "Sahan Cepte tamamen ücretsiz,tüm kullanıcalara açık bir platformdur.Extra hiçbir ödemeden rezervasyonlarınızı kolaylıkla yapabilirsiniz." },
