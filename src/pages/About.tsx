...
import icon1 from '/src/assets/images/about/white.png';
    ...
    <div style={{ paddingTop: '5rem', paddingLeft: '1rem' }}>
      <Box sx={{ width: '100vw', display: 'flex', flexDirection: 'row' }}>
        <Box sx={{ width: '60vw', display: 'flex', flexDirection: 'column', fontFamily: 'Open Sans', fontSize: '2rem', color: '#333', paddingLeft: '5rem' }}>
          ...
          <Box sx={{ color: '#252F40', fontSize: '2rem', fontFamily: 'Open Sans', fontWeight: 'bold' }}>
            Tek Tık’la Rezervasyon Yap !
          </Box>
          <Box sx={{ width: '40vw', fontSize: '1rem', color: '#67748E', paddingTop: '2rem',fontFamily: 'Roboto', fontWeight: 400 }}>
            <Box>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', paddingTop: '4rem' }}>
            <Box sx={{ display: 'flex', flexDirection: 'row', width: '40vw' }}>
              ...
              <Box sx={{ fontSize: '1rem', fontFamily: 'Roboto', fontWeight: 400, color: '#67748E', paddingTop: '0.2rem', paddingLeft: '1rem' }}>
          ...
          <Box sx={{ fontFamily: 'Open Sans', fontSize: '2rem', fontWeight: 700, color: '#252F40', paddingTop: '4rem' }}>
            Neden Sahan Cepte ?
          </Box>

          <Box sx={{ display: 'flex', flexDirection: 'column', paddingTop: '2rem' ,paddingBottom: '7rem' }}>
            <Box sx={{ display: 'flex', flexDirection: 'column' }}>
              <Box sx={{ fontFamily: 'Roboto', fontSize: '1.25rem', fontWeight: 700, color: '#000000' }}>Ücretsiz ve Kolay Üyelik</Box>
              <Box sx={{ paddingTop: '1rem', fontSize: "1rem", fontFamily: "Roboto", color: '#67748E', fontWeight: 400 }}>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</Box>
            </Box>
            <Box sx={{ display: 'flex', flexDirection: 'column', paddingTop: '1.5rem' }}>
              <Box sx={{ fontFamily: 'Roboto', fontSize: '1.25rem', fontWeight: 700, color: '#000000' }}>Tesis Özelliklerine Kolay Erişim</Box>
              <Box sx={{ paddingTop: '1rem', fontSize: "1rem", fontFamily: "Roboto", color: '#67748E', fontWeight: 400 }}>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</Box>
            </Box>
            <Box sx={{ display: 'flex', flexDirection: 'column', paddingTop: '1.5rem' }}>
              <Box sx={{ fontFamily: 'Roboto', fontSize: '1.25rem', fontWeight: 700, color: '#000000' }}>Tesisin Değerlendirilmesi</Box>
              <Box sx={{ paddingTop: '1rem', fontSize: "1rem", fontFamily: "Roboto", color: '#67748E', fontWeight: 400 }}>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</Box>
            </Box>
          </Box>
